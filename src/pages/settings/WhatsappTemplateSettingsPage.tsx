...
type WhatsappTemplateSettingsPageProps = {
...
const WhatsappTemplateSettingsPage: React.FC<WhatsappTemplateSettingsPageProps> = ({
  settings,
  setSettings,
  canSave,
  isSaving,
            ...
            <section>
              ...
              <div className="mt-2 rounded-[22px] border border-border-subtle bg-bg-card p-4">
                ...
                <div className="mt-2 text-[12px] leading-4 text-text-secondary">
                  ...
                  <span className="ml-2 font-semibold">{'{suburb}'}</span>,
                  <span className="ml-2 font-semibold">{'{campaign}'}</span>,
                ...
                <div className="mt-4 rounded-[18px] border border-border-subtle bg-bg-primary px-4 py-3">
                  ...
                  <div className="mt-2 whitespace-pre-wrap text-[13px] leading-5 font-medium text-text-primary">
                    {renderWhatsappTemplate(settings.defaultWhatsappTemplate, {
                      ...
                      suburb: 'Port Alfred',
                      campaign: 'Vanqr',
                      serviceType: settings.serviceTypeOptions?.[0] || '',
                    })}
                  </div>
                </div>

                <div className="mt-3 text-[12px] leading-4 text-text-secondary/80">Keep it short. End with a clear next step.</div>
              </div>
            </section>
          </div>
        )}
...
export default WhatsappTemplateSettingsPage;
